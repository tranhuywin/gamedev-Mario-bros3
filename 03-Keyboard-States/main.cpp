...
void CSampleKeyHander::OnKeyDown(int KeyCode)
{
	...
	case DIK_RSHIFT:
	case DIK_LSHIFT:
		mario->SetState(MARIO_STATE_FAST);
		break;
	}
}
...
void LoadResources()
{
	...
	sprites->Add(10015, 426, 239, 444, 257, texMario);
	sprites->Add(10016, 6, 239, 20, 257, texMario);
	...
	CMario::AddAnimation(502);		// idle bottom right
	CMario::AddAnimation(503);		// idle bottom left
