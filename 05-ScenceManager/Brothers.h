...
#define BROTHER_DEFLECT_SPEED		0.3f	
...
class Brothers : public CGameObject
{
	...
	int IDTypeBrother;
	int ani = 0;
	int WaitAttackBoom1, WaitAttackBoom2, WaitThrow1, WaitThrow2;
	DWORD WaitAttackBoom1_start, WaitAttackBoom2_start, Attack_start;
	DWORD WaitThrow1_start, WaitThrow2_start;
public:
	...
	void StartWaitThrow1() { WaitThrow1 = 1; WaitThrow1_start = GetTickCount64(); }
