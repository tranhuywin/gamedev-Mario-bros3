...
CMario *mario;
CGoomba *goomba;
GoombaBoomerang* goombaboomerang;
...
void LoadResources()
{
	...
	sprites->Add(40005, 90, 173, 106, 202, texEnemy); // goomba_bummerang
	sprites->Add(40006, 67, 173, 83, 202, texEnemy);
	sprites->Add(40007, 37, 173, 61, 202, texEnemy);
	sprites->Add(40008, 8, 173, 32, 202, texEnemy);

	sprites->Add(40009, 92, 208, 92 + 16, 208 + 16, texEnemy); //  bummerang
	sprites->Add(40010, 68, 209, 68 + 16, 209 + 16, texEnemy);
	sprites->Add(40011, 42, 209, 42 + 16, 209 + 16, texEnemy);
	sprites->Add(40012, 17, 209, 17 + 16, 209 + 16, texEnemy);
	LPANIMATION ani;
	...
	ani = new CAnimation(100);		// Goomba_prepare_bummerang
	ani->Add(40005);
	ani->Add(40006);
	animations->Add(705, ani);

	ani = new CAnimation(100);		// Goomba_bummerang
	ani->Add(40007);
	ani->Add(40008);
	animations->Add(707, ani);
	ani = new CAnimation(100);		// bummerang
	ani->Add(40009);
	ani->Add(40010);
	ani->Add(40011);
	ani->Add(40012);
	...
	goombaboomerang = new GoombaBoomerang();
	goombaboomerang->AddAnimation(705); //attack
	goombaboomerang->AddAnimation(706); //bumerang
	goombaboomerang->AddAnimation(707); //Prepare attack
	goombaboomerang->AddAnimation(708); //Prepare bumerang
	goombaboomerang->SetPosition(84.0f, 125);
	goombaboomerang->SetState(GOOMBA_STAGE_PREPARE_ATTACK);
	objects.push_back(goombaboomerang);
